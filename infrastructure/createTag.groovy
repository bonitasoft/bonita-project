            ...
            steps {
                script {
                    sh """
                        ...
                        ./mvnw -ntp versions:set -DnewVersion=${params.TAG_NAME} -Ptest,versionsUpdate
                        ./mvnw -ntp -f parent versions:set-property -Dproperty=bonita.runtime.version -DnewVersion=${params.TAG_NAME} -PversionsUpdate
                        ./mvnw -ntp -f parent versions:set-property -Dproperty=branding.version -DnewVersion=${params.NEW_BRANDING_VERSION} -PversionsUpdate
