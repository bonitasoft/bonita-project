...
assert new File(classpathFolder, 'bonita-connector-email-1.3.0.jar').exists() : 'bonita-connector-email should be included in the webapp classpath when bonita.includeDependencyJars=false'
